...
options_optim = optimoptions(@fmincon,'Display','iter-detailed',...
    ...
    'MaxIterations',1000,'MaxFunctionEvaluations',5e4);
...
toc;
    ...
    title_text2 = ['Estimate variaton sources, Z, by interior-point, Z_0 = X_{PCA}, fix variance',10,'Vectorized Lifted Brownian kernel calculation (t=',num2str(toc),',iter=5e4)'];
if scat_func_tag == 1
    tag = 0; %tag for showing index of data in 2d scatter plot (0: not showing)
