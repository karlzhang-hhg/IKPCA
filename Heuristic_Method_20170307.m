%% Heuristic algorithm based on the optimization results from the weekly report on 20170307
...
%     %didn't use conjugate symmetry, while 'asymmetric K' means I use conjugate symmetry 
    ...
    K_est = Gaussian_Kernel_vect(Z_est,options);%Just let the variance of each Z_est to be unit
