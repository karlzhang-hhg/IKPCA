...
options_optim = optimoptions(@fminunc,'Display','iter-detailed',...
    ...
    'MaxIterations',1000,'MaxFunctionEvaluations',1e3);
...
toc;
    ...
    title_text2 = ['Estimate variaton sources, Z, by quasi-netwon, Z_0 = X_{PCA}',10,'Vectorized Gaussian kernel calculation (t=',num2str(toc),',iter=1000)'];
if scat_func_tag == 1
    tag = 0; %tag for showing index of data in 2d scatter plot (0: not showing)
